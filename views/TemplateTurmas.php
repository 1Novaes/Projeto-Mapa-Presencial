            ...
            <nav class="nav-wraper teal  darken-4 z-depth-0">
                <div class="container">
                    <a href="" class="brand-logo">
                        <img src="assests/img/logomapa.png" classe="responsive-img">
                        Controle de Turmas
                    </a>
                    ...
                    <div id="crud-view-content">
                        ...
                        <div class="row container">
                            <form id="form-data">
                                ...
                                <fieldset>
                                    <legend>Controle de Turmas</legend>
                                    <div class="input-field col s12">
                                        <input type="text" class="validate" name="descricao" size="100">
                                    ...
                                    <div class="input-field col s12 m12 l8">
                                        ...
                                        <select>
                                            ...
                                            <option value="1" name="curso">Técnico em Administração</option>
                                            <option value="2" name="curso">Técnico em Logistica</option>
                                            <option value="3" name="curso">Técnico em Informática para internet</option>
                                        </select>

                                        <label for="curso">Escolha o curso</label>
                                        <span class="helper-text" data-error="valor inválido" data-success="válido"></span>
                                    </div>

                                    <div class="input-field col s12 m12 l8">
                                        <select>
                                            <option value="" disabled selected></option>
                                            <option value="1" name="modalidade">Concomitância externa</option>
                                            <option value="2" name="modalidade">Integrado - concluído fundamental</option>
                                            <option value="3" name="modalidade">Subsequente - pós médio</option>

                                        </select>
                                        <label for="modalidade">Escolha modalidade</label>
                                    </div>

                                    <div class="input-field col s12 m12 l8">
                                        <select>
                                            <option value="" disabled selected></option>
                                            <option value="1" name="etapa">Primeira etapa</option>
                                            <option value="2" name="etapa">Segunda etapa</option>
                                            <option value="3" name="etapa">Terceira etapa</option>
                                            <option value="4" name="etapa">Quarta etapa</option>
                                        </select>
                                        <label for="etapa">Escolha a etapa</label>
                                    </div>
                                    <div class="input-field col s12 m12 l8">

                                        <fieldset>
                                            <legend> Marque o turno </legend>

                                            <p>
                                                <label>
                                                    <input name="turno" type="radio" value="M" />
                                                    <span>Matutino</span>
                                                </label>
                                            </p>
                                            <p>
                                                <label>
                                                    <input name="turno" type="radio" value="V" />
                                                    <span>Vespertino</span>
                                                </label>
                                            </p>
                                            <p>
                                                <label>
                                                    <input name="turno" type="radio" value="N" />
                                                    <span>Noturno</span>
                                                </label>
                                            </p>
                                            <p>
                                                <label>
                                                    <input name="turno" type="radio" value="I" />
                                                    <span>Integral</span>
                                                </label>
                                            </p>
