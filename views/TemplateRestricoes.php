...
<head>
    <title>Controle de Restrições</title>
    <meta charset="UTF-8">
                    ...
                    <div id="crud-view-content">
                        ...
                        <div class="row container">
                            <form id="form-data">
                                ...
                                <fieldset>
                                    <legend>Controle de Restrições</legend>
                                    <input type="hidden" name="id" value="" />
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input placeholder="CPF 11 DIGITOS" type="text" class="validate">
                                            <label for="cpf">CPF</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input placeholder="Descrição" type="text" class="validate">
                                            <label for="descricao">Descreva a drestrição</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s16">
                                            <input placeholder="Data de inicio da restrição" type="text" class="validate">
                                            <label for="dtinicial">Data matricula</label>
                                        </div>
                                        <div class="input-field col s6">
                                            <input placeholder="Data de termino da restrição" type="text" class="validate">
                                            <label for="dtfinal">Data conclusão</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s6">
