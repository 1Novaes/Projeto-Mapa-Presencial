                    ...
                    <div id="crud-view-content">
                        ...
                        <div class="row container">
                            <form id="form-data">
                                ...
                                <fieldset>
                                    <legend>Controle de avisos</legend>
                                    <input type="hidden" name="id" value="" />
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input placeholder="titulo" type="text" class="validate">
                                            <label for="titulo">Dê um titulo</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <textarea id="textarea1" class="materialize-textarea"></textarea>
                                            <label for="aviso">Digite o aviso</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s16">
                                            <input placeholder="Data" type="text" class="validate">
                                            <label for="dthora">Data e hora</label>
                                        </div>
