                                ...
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="input-field col s3">
                                            <input placeholder="CPF 11 DIGITOS" type="text" name="cpf" class="validate">
                                            <label for="cpf">CPF</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s63">
                                            <input placeholder="Matricula do aluno(a)" id="matricula" type="text" name="matricula" class="validate">
                                            <label for="matricula">Matricula</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s3">
                                            <input placeholder="Data da matricula" type="text" name="dtmatricula" class="validate">
                                            <label for="dtmatricula">Data matricula</label>
                                        </div>
                                        <div class="input-field col s3">
                                            <input id="Data da conclusdão" type="text" name="dtcoclusao" class="validate">
