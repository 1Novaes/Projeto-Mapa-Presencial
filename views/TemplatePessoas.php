                    ...
                    <div id="crud-view-content">
                        ...
                        <div class="row container">
                            <form id="form-data">
                                ...
                                <fieldset>
                                    <legend>Controle de Pessoas</legend>
                                    <input type="hidden" name="id" value="" />
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input placeholder="CPF 11 DIGITOS" id="first_name" type="text" class="validate">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input placeholder="Telefone 1" id="tel1" type="text" class="validate">
                                            <label for="tel1">Telfefone 1 (Obrigatório)</label>
                                        </div>
                                        <div class="input-field col s6">
                                            <input id="tel2" type="text" class="validate">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input id="necessidade" type="text" class="validate">
                                            <label for="necessidade">Necessidades especiais - se sim descreva</label>
                                        </div>
                                    </div>
                                </fieldset>
